...
v <- read_tcad("K:/Planning/Modeling/Jake's files/Original TRMv6.2_2016 - Copy/Input/Highway/Highway_Line.bin") 
v[is.na(v)]<-0
...
```{r}
g2 <-  read_tcad("C:/Users/JacobFo/TRMG2_v0.2/scenarios/base_2016/output/networks/scenario_links.bin") %>%
  select(ID, HCMType, DailyCount, AB_Flow_Daily, BA_Flow_Daily, Total_Flow_Daily,)
...
observed <-read_tcad("c:/Users/JacobFo/OneDrive - City of Durham/Full Model Runs/Original TRMv6.2_2016 - Copy/EvalModule/Transit_Ridership_Observed_2016.bin") %>%
